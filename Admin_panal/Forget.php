                ...
                <div class="col-12 col-lg-6 pl-lg-2">
                    ...
                    <form>
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control border-light input-h-42" placeholder="Username" required>
                        </div>
                        <div class="form-group mb-4">
                            <label>Email Id</label>
                            <input type="text" class="form-control border-light input-h-42" placeholder="john.doe@domain.com" required>
                        </div>
                        <div class="form-group mb-4">
                            <label>Password</label>
                            <input type="password" class="form-control border-light input-h-42" placeholder="Password" aria-label="Password" required>
                        </div>
                        <div class="form-group mb-4">
                            <label>Confirm Password</label>
                            <input type="text" class="form-control border-light input-h-42" placeholder="Confirm Password" aria-label="Password" required>
                        </div>
